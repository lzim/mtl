...
- **6. Select VHA Primary Role** - Select your primary VHA role from the dropdown menu.
...
4. Click “Submit.” If you are the first person to register from your Facility Team, a window will appear.
5. Enter your facility team name as shown below:

>image needed once design is finalized
...
6. Click “Submit.” After your registration request is reviewed and approved, an approval email will be sent to your VA address that contains login information for accessing the _MTL_ Sim UI.
