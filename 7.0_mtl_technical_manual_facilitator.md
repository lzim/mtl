...
1. Click the SME icon. A Team Setup - Add Subject Matter Experts popup will appear.
...
1. Click the Add icon. A Setup popup will appear. **The Setup will not list all teams in Epicenter. It will only list teams assigned to the user.**
...
If you are an administrator, use your login to access multiple team’s menu results. The system knows you are an administrator based on your user id and will present the administrator popup. From the popup, you can review the results of multiple teams.
...
> _Include link to or screenshot of data_cheatsheet here?_
...
> Cannot find the focus mode mentioned below:
...
> _Steps 9 & 10 below & associated T&Ts not so much about Clinic Selections -- remove?_
...
> _Is this information still relevant?:_
> 
> **Please Note:**
> 
...
> _Is this still true/relevant?:_
...
> - Once you pick a Learning Mode to prioritize EPRVI or NPSR, this will be the setting your team will experiment with for the rest of the _Modeling to Learn_ program.
