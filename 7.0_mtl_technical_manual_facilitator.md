...
4.  **More**: Click to reveal other key views of the module. Depending on the module selected, the More menu may include: Feedback Loops, Flow, Decision Meters, Episodes of Care, Play, Team Data, and SAIL Data. 
5.  **Services**: This allows you to see stock values for specific services (Intake, Care Coordination, Medication Management, Psychotherapy, Evidence-based Psychotherapy, Adjunctive Services, Group Therapy).
6.  **Text with Red Background**: Indicates which Learning Mode the model is using to simulate.
...
9.  **Setting**: This allows you to see stock values for setting-specific services (General Mental Health, Specialty Mental Health, Primary Care/Primary Care Mental Health Integration).
