...
<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_add.png?raw=true">
  ...
  - Enter First Name, Last Name, and Email. Use the Select Permissions dropdown to assign the team member's permissions on the team. Use the Select VHA Primary Role dropdown to assign the team member's role on the team, then click the Add. Click Done when finished.
...
<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_edit_member.png?raw=true">
  ...
  - Make changes as needed to the First Name, Last Name, Permissions, Email, and/or VHA Primary Role fields. Click Done when finished.
