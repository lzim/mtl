...
- **3 - Lookup Supervisor**: Search for "zimmerman, l" (everyone but the QIICs can use Lindsey as the supervisor for this access, or use Cliff – Cliff or Lindsey will receive an email and approve the request):

> waiting on response from lzim re: Cliff's last name to help with above search
