...
1. Navigate to [mtl.how/register](mtl.how/register) in your Edge, Firefox, or Chrome browser.
...
- **5. Repeat Password** - Re-enter the password you just created.

    - **Note:** To check if both passwords match, click the eye with a slash icon in each field to reveal what you typed.
...
- **10. Create New Facility Team** - _If you are a **team lead**_: Do nothing here; this is the option you want. _If you are a **team member**_: Select your team from the drop-down menu.
...
5. _This step only applies **team leads**:_ Enter your facility team name in the pop-up window (immediately after the pre-populated information).

- **You must only use lowercase letters.**
- **You must use the underscore character (_) instead of spaces.**
