...
2. Click on the Clinic Selection tab and select and view your local team data.
...
4. Hover over the Clinic Name -> Providers heading and click on the ellipsis that appears.
...
6. The Team Data file is exported to your browser's download location. Save using our Team naming convention "Sta3n_geo-location_clinic_year_month_day" and post the file on the shared Team channel for Team members to view and confirm selections. 

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_file_name.png?raw=true">

7. Repeat steps 2-6 with Team Flow Selections.
...
> steps 8 & 9 below & associated T&Ts not so much about Clinic Selections; remove?
