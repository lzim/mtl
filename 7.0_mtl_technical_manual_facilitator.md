# Facilitator Technical Manuals what the heck?
...
- **5. Repeat Password** - Re-enter the password you just created.
    ...
    _Note: To check if both passwords match, click the eye with a slash icon in each field to reveal what you typed._
...
5. Enter your facility team name in the pop-up window (immediately after the pre-populated information).
