...
1. Click the Add icon. A Team Setup popup will appear. **The Team Setup will not list all teams in Epicenter. It will only list teams assigned to the user.**
...
2. Within the Data area of this pop-up, select the team data file(s) you want to upload and click the "Add" button to add the file.
...
3. A Please select a world popup will appear.  Select the worlds in which you want the team data to appear. 
...
- A popup window will appear asking if the data file is in Power BI format. Ensure it is and Press Yes to proceed. The File Manager will appear.
