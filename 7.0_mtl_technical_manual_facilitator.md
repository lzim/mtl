...
This section describes how one can self-register for an account in the Sim UI. You need only provide basic information and a VA email address to start the process. Once the registration form is completed, a notice will be sent to an approver. Once approved, the user will be notified by email they now have access to the dashboard.  See the next section for information on how to use the dashboard to manage an _MTL_ team.

1. Go to [mtl.how/sim](mtl.how/sim) in your Edge, Firefox, or Chrome browser.
2. Click on Register for First Time in the login window:

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_login_screen.png?raw=true">

3. Complete the self-registration form as shown below:
...
- **4. Password** - Create a password and enter it here. Write it down so you don’t forget.
- **5. Repeat Password** - Re-enter the password you just created. _Note: to check if both passwords you entered are the same, click the eye with a slash icon in each field to reveal what you typed._
...
- **10. Create New Facility Team** - Do nothing here; this is the option you want.

4. Click the green Submit button. If you are the first person to register from your Facility Team, the following pop-up message will appear (with your VISN, Facility, and Clinic pre-populated):

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_popup_team_name.png?raw=true">

5. Enter your facility team name.

- **Use lowercase for all letters** in the facility team name.
- **Use the underscore character (_)** instead of spaces in the facility team name field.
- If you forget to use these standards when naming your team, it will autocorrect for you.

6. Click Submit. The following message will appear for a few seconds in the upper right-hand corner of your browser window:
