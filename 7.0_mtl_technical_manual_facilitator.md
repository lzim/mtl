...
-When someone deletes a team eata file in a _shared or _team world, they are deleting it from _shared and _team worlds for all users of those worlds. This does _not_ impact individual worlds.
-When someone uploads a team eata file into a _shared or _team world, it should be available in _team and _shared worlds for all users of those worlds.
-When someone uploads a team eata file to an _ind (individual) world, it is only available to themselves and all _MTL_ administrators who may need to provide support.
...
> may need to change step #1 based on feedback from DEV July 12+...
