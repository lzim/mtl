...
**Note:** Only Administrators and the internal team have access to this function. Field users can upload their data file(s) from the Dynamic Decision Dashboard (as well as Administrators and the internal team). Field users should refer to the Dynamic Decision Dashboard section below.
...
3. A Please select a world pop-up will appear.  Select the worlds in which you want the team data to appear and click Upload.
...
**Tip:** Refer to this [Sim UI cheatsheet](https://github.com/lzim/mtl/blob/master/blue/session05/s05_learner/mtl_how_sim_cheatsheet.pdf) when running an experiment.
