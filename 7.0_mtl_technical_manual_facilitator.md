...
The following chapters will help answer any technical questions you may have when preparing for your team's live session.

<img src="https://github.com/lzim/teampsd/blob/master/resources/logos/mtl_consult.png" height="175px" width='290px'/>
...
> Need to be updated to reflect 3.7:
>
> ### CPT Code Cheatsheet
>
...
This section explains how to use the Administrator Dashboard to set up and manage teams. It also orients users to the Dynamic Decision Dashboard and explains how to access mtl.how/menu and set up _MTL_ Report content. Below is an orientation to the Dashboard.
...
10. **Select Module** - Use this dropdown to select the desired module.

11. **Gauges** - This indicates the teams' progress with a selected experiment. Teams receive 20% completion for a minimum 50 characters input for each of the Question, Hypothesis, Findings, Decisions fields and another 20% for running the experiment.

12. **Select Experiment** - Use this dropdown to select the desired experiment to monitor. An experiment will not show in this dropdown until it has been named and saved.

13. **Expand / Collapse Dropdown Triangle** - Manage and monitor multiple teams by selecting this dropdown.

14. **CLOSE** - Click to de-select a team.

15. **ADD TEAM** - Click to add an unlimited number of teams to the dashboard. 

## Set Up a Team

This section describes how to set up a team manually. Once team setup is complete, users can access [mtl.how/menu](https://forio.com/app/va/va-psd-mtlmenu/survey.html) and use the Dynamic Decision Dashboard.
...
1. **SME** - Click to create and maintain a list of SMEs that will be auto-added or removed when a new team is set up. It also updates existing team member listings.
2. **Add** - Click to add a team.
3. **Edit** - Select a team first, then click here to edit that team.
4. **Delete** - Select a team first, then click here to delete that team.

### Add or Remove Subject Matter Experts (SMEs)

1. Click the SME icon. A Team Setup - Add Subject Matter Experts pop-up will appear.

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_sme.png?raw=true">

2. To add SMEs, enter First Name, Last Name, and Email. Then click Add.
  - Note: The user must already be registered to be added as a SME.

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_add_sme_popup.png?raw=true">

3. To delete SMEs, select the checkbox(es) next to the SME(s) you wish to delete. Then click Delete.

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_delete_sme_popup.png?raw=true">

> _Are these correct/relevant?: DOUBLE CHECK._
> 
> **Notes:**
> 
> - If a SME member is deleted from a group/team, the entire team will be deleted.
> - If a SME member user is removed from the list, the user will not see the list of groups/teams. Users added to the SME member list determines whether or not they can see the entire list of groups/teams.

### Add a Team

1. Click the Add icon. A Setup pop-up will appear. **The Setup will not list all teams in Epicenter. It will only list teams assigned to the user.**

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_add.png?raw=true">

2. Add the team name.  Just add the team's root name. The setup function will automatically add "_team", "_ind", and "_shared" extensions in Epicenter.
...
6. Use the Select Permissions dropdown to assign the team member's permissions on the team.

7. Use the Select VHA Primary Role dropdown to assign the team members' roles on the team.
...
<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_add.png?raw=true">
  ...
  - Enter First Name, Last Name, and Email. Use the Select Permissions dropdown to assign the team member's permissions on the team. Use the Select VHA Primary Role dropdown to assign the team member's role on the team, then click the Add icon.
...
**Note:** More than one team member at a time may be selected for deletion.
...
If you are an administrator, use your login to access multiple team’s menu results. The system knows you are an administrator based on your user id and will present the administrator pop-up. From the pop-up, you can review the results of multiple teams.
...
- To zoom into the screen, hover in the upper right-hand corner of the screen until a set of icons appear.
  - Click on the square Focus Mode icon. Click Back to Report to return to the previous view. **Note:** Focus Mode is found in the data and viz tabs only. 
...
**Note:** Only SMEs and internal team have access to this function. Field users can upload their data file(s) from the Dynamic Decision Dashboard (as well as SMEs and internal team). Refer to the Dynamic Decision Dashboard section below.

1. In the Administrator Dashboard, click Settings.

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/nav_to_team_setup.png?raw=true">

2. Within the Data area of this pop-up, select the team data file(s) you want to upload and click the Add icon to add the file.

- **NOTE:** Administrators can upload team data files themselves and assign that file to team(s) of their choice. If a team data file has already been uploaded to the vault, but not for your team, you can add it by selecting it from the list of data files given here.

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/manage_team_data.png?raw=true">
 
3. A Please select a world pop-up will appear.  Select the worlds in which you want the team data to appear. 

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/fac_db_select_worlds.png?raw=true">
 
4. Click Upload. A pop-up window will appear asking if the data file is in Power BI format. Ensure it is and click Yes to proceed. The File Manager will appear.
...
1. From the Administrator Dashboard, select a team from the Select Team dropdown, select a module (if desired), then click Home. The Home page of the selected team will appear.

<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/ddd_home.png?raw=true">

Below is a basic orientation to this Home page:
...
> May need to update More menu screenshot below, depending on final DDD design.
...
6. **Learning Mode Label**: Indicates which Learning Mode the data prioritizes. Click these buttons to change the learning modes directly from the DDD; the system will re-initialize based on the new learning mode selected.
...
> Screenshot below may need to change, depends upon final design of DDD.
...
**Tip:** Save this [Sim UI cheatsheet](https://github.com/lzim/mtl/blob/master/blue/session05/s05_learner/mtl_how_sim_cheatsheet.pdf) when running an experiment!
...
> - The _MTL_ Reports pop-up allows you to select your team, select experiments to display and the specific charts you want to display in the report.
...
2. Select _mtl_ Reports from the Facilitator Dashboard. The _MTL_ Reports pop-up will appear.

3. Use the following screenshot and numbered pins to help populate the _MTL_ Reports pop-up fields. Fields with an asterisk are required.

> screenshot of pop-up w/numbered pins
...
4. Scroll down to the bottom of the pop-up and select Save.
...
---
> **OLD INFO:
> 1. Select tt Admin from the Facilitator Dashboard. The tt Reports pop-up will appear.
...
- There is a special button in the Team Setup pop-up for the team data to experiment conversion.
...
1. Select Settings from the Facilitator Dashboard. The Settings pop-up will appear.
...
4. Select _MTL_ Reports. The _MTL_ Reports pop-up will appear.
...
> **OLD INFO NOT USED:**
> 5. Close the Team Setup pop-up and click on the mtl Reports button.  The _MTL_ Reports pop-up will appear.
> 
