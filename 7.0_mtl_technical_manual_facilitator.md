...
**Notes:**
- If you hold the Administrator role in any group, along with being added into administrator_login on Epicenter, you will be allowed to login using the administrator_login world. Otherwise, the Sim will load teams and, upon selecting a team, you will be directed to that team's Home Page (bypassing the Administrator Dashboard).

## Sim UI Administrator Dashboard

This section provides familiarization with the Administrator Dashboard and explains how to use this dashboard to set up and manage teams. 
...
**Note:** Teams shown under Facility Team Setup are ones you have joined and in which you have the 'Administrator' role. 'Lead' and 'Member' permissions teams won't be visible for the logged-in user.
...
8. Click the Add icon.
  ...
  - Note: Click the checkbox next to a name and the select Edit or Delete to update information or delete a team member.
...
2. Within the Data side of this pop-up, select the team data file(s) you want to associate with a team and click the Add icon.
...
3. A Please select a world pop-up will appear. Select the worlds in which you want the team data to appear and click Add.
...
<img src = "htttps://github.com/lzim/mtl/blob/gh-pages/images/team_data_added.png?raw=true">
...
**Note:** If you have the Administrator role in any team and have been added into "administrator_login" on Epicenter,
   - You will be allowed to login using the "administrator_login" dropdown choice.
   - Otherwise, it will load teams and once you select a team, you will be redirected to the Home page of that team and bypass the Administrator Dashboard.
...
4. Complete the Issue Form. **Do not include PII or other Site identifiable information. Instead, use generic language such as “MTL Blue live team on Mondays at 9am.”**
