...
- Use the most recent clinic selection table [located in this folder](\\r01palhsm07.r01.med.va.gov\PAL_Research\NCPTSD\Shared Research\TeamPSD\Grants\0_final_post_covid19_site_list) to find the full Sta6a. **Note:** This site list is for SMEs and our internal team; it is _not_ applicable for field users.
...
The Dynamic Decision Dashboard (DDD) is a convenient visual way to help answer the question  _Where is the volume (of Veterans) across all modules?_ The primary purpose of these visuals is to help understand the dynamic system that is veteran care. The dashboard shows a visual representation of where veterans accumulate and where the inflow/outflow is coming from/moving to.  This aids in understanding how different quantities change and interact over time within a system and identifying key variables that contribute to the accumulation or depletion of stocks.
