...
This section explains how to use the Facilitator Dashboard to set up and manage teams.  It also explains how to access mtl.how/menu and set up _MTL_ Report content. Below is an orientation to the Dashboard.
...
12. **Expand / Collapse Dropdown Triange** - Manage and monitor multiple teams by selecting this dropdown.
...
> add visual of dashboard here with geotag-type labels 1-4

### Get to know the Dashboard
There are four windows within the dashboard:

- **1. Session Start** window: Select the team data you wish to use from the dropdown menu.

- **2. Experiment** window: Description here.

- **3. Team Data** window: Description here.

- **4. Dynamic Decision Dashboard** window: The Dynamic Decision Dashboard answers the question  _Where is the volume across all the modules?_ It shows a visual representation of where veterans accumulate and where the inflow/outflow is coming from. The primary purpose of these visuals is to help understand the dynamic system that is veteran care. This aids in comprehending how different quantities change and interact over time within a system and identifying key variables that contribute to the accumulation or depletion of stocks. 
...
Within the Dynamic Decision Dashboard, there are five sections: Care Coordination, Medication Management, Team Flow, Team Care, and Psychotherapy. To the right of each section are icons, each with an associated dropdown menu. See below for dropdown menu contents and descriptions.

#### More Dropdown
Shown with an ellipsis, this menu includes links to:
- Causal Feedback Loops
- Flow
- Decision Meters
- Episodes of Care
- Play
- Team Data (navigates to mtl.how/data)
- SAIL Data (navigates to mtl.how/sail)

#### Array Dropdowns
Shown with three stacked sheets, the array dropdown menus vary depending upon which section it is in.

#### Patient Services Array
Radio button choices within the Patient Services array are:
- Intake
- Care Coordination
...
##### Patient Cohorts Array
Radio button choices within the Patient Cohorts array are:
...
##### Setting Array
Radio buttton choices within the Setting array are: 
...
This section describes how a facilitator can set up a team manually, or use a Customer Management System (CMS) export to set up a team. **Team setup normally occurs by the end of _MTL_ Session 2, so the learners can access 
...
## Review mtl Reports Menu Results
