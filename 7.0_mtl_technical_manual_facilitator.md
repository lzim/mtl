...
This section describes how a facilitator can set up a team manually, or use a Customer Management System (CMS) export to set up a team. Once team setup is complete, users can access mtl.how/menu.
...
The Dynamic Decision Dashboard is a convenient visual way that helps answer the question  _Where is the volume (of veterans) across all modules?_ The primary purpose of these visuals is to help understand the dynamic system that is veteran care. The dashboard shows a visual representation of where veterans accumulate and where the inflow/outflow is coming from.  This aids in understanding how different quantities change and interact over time within a system and identifying key variables that contribute to the accumulation or depletion of stocks.
