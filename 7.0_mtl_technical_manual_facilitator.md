...
1. Click the "SME" button. A Team Setup - Add Subject Matter Experts popup will appear.
...
<img src = "https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_add_team_popup.png?raw=true">
...
3. Add the teams' consult vision. This is a required field.

4. Click "Add" button to add a team member. A Setup - Add Members pop-up will appear. 
...
7. Use the Select VHA Primary Role dropdown to assign the team member's roles on the team.
