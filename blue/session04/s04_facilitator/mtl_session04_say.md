...
2. Remember, all the _MTL_ resources can be accessed from your home base at mtl.how/test/test if you forget a specific link. But to go directly to the log-in page for the sim UI, just type mtl.how/test/sim_test into your browser.
