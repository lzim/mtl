...
- At[mtl.how/data_test_test](https://mtl.how/data_test_test), click on **"Data UI (Team Data)"**. In the Dropdown menu that appears, click on the  **ClinicSelection tab**. 
