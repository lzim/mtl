...
<img alt="Image of the registration page." src="https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_login_screen.png?raw=true">
...
<img alt="Image of registration form." src="https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_form.png?raw=true">
...
<img alt="Image of complete your facility's team name window." src="https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_popup_team_name.png?raw=true">
...
<img alt="Image of forwarded to approver screen message." src="https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_forwarded_approver.png?raw=true">
...
<img alt="Image of approval email." src="https://github.com/lzim/mtl/blob/gh-pages/images/self_registration_approval_email.png?raw=true">
...
<img alt="Image of Sim UI login page." src="https://github.com/lzim/mtl/blob/gh-pages/images/sim_login.png?raw=true">
...
<img alt="Image of Sim UI Administrator Dashboard." src="https://github.com/lzim/mtl/blob/gh-pages/images/dashboard_overview.png?raw=true">
...
<img alt="Image of Dynamic Decision Dashboard Settings button with highlighting." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_settings.png?raw=true">

Within the Facility Team Setup area of this pop-up, several team setup options are available and are described below:

<img alt="Image of team setup options found in the Settings window." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_overview.png?raw=true">
...
<img alt="Image of Settings window with Add button highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_add.png?raw=true">
...
<img alt="Image of Setup - Add Members pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/add_team_pop_up.png?raw=true">
...
<img alt="Image of Setup - Add Members popup with arrows pointing at fields to complete." src="https://github.com/lzim/mtl/blob/gh-pages/images/setup_add_members_popup.png?raw=true">

### Edit a Team

1. Click the checkbox next to the team you want to edit, then click the Edit icon. An Edit Setup screen will appear.

<img alt="Image of Settings window with team selected and Edit button highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_setup_edit.png?raw=true">

2. Within the Edit Setup screen, you may add, edit, or delete team members from your selected team.

<img alt="Image of Edit Setup pop-up with action buttons highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_popup.png?raw=true">

2a. To add a new team member, click the Add icon. A Setup - Add Members pop-up will appear.

<img alt="Image of Edit Setup window with Add button highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_add.png?raw=true">
...
<img alt="Image of Setup - Add Members pop-up with arrows pointing at fields to complete." src="https://github.com/lzim/mtl/blob/gh-pages/images/setup_add_members_popup.png?raw=true">
...
<img alt="Image of Edit Setup pop-up with arrows pointing at selected member and the Edit button." src="https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_edit_member.png?raw=true">

  - Make changes as needed to the First Name, Last Name, Permissions, Email, and/or VHA Primary Role fields.

<img alt="Image of Setup - Edit Members pop-up with arrows pointing at fields to complete." src="https://github.com/lzim/mtl/blob/gh-pages/images/setup_edit_members_popup.png?raw=true">
...
<img alt="Image of Edit Setup pop-up with arrows pointing at selected member and the Delete button." src="https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_delete_member.png?raw=true">
...
<img alt="Image of confirmation message when deleting team members." src="https://github.com/lzim/mtl/blob/gh-pages/images/edit_setup_delete_member_confirm.png?raw=true">
...
<img alt="Image of selected teams highlighted and arrow pointing at the Delete button." src="https://github.com/lzim/mtl/blob/gh-pages/images/settings_delete_team.png?raw=true">
...
<img alt="Image of confirmation message when deleting selected team(s)." src="https://github.com/lzim/mtl/blob/gh-pages/images/settings_delete_team_confirm.png?raw=true">
...
<img alt="Image of browser address bar with an arrow pointing to mtl.how/data." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_nav.png?raw=true">

2. Using the left-hand navigation pane, navigate to the desired Region and VISN.

<img alt="Image of _Modeling to Learn_ Data UI home page with an arrow pointing to left-hand navigation pane." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_visn_nav.png?raw=true">

3. Click on the Clinic Selection tab and select and view your local team data.

<img alt="Image of Clinic Selection window with arrows pointing to possible filters." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_select_data.png?raw=true">
...
<img alt="Image of Personal Bookmarks - Add a personal bookmark navigation." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_bookmark.png?raw=true">

4. Scroll until you see the View Clinic Selections tab on the left-hand side.

<img alt="Image of View Clinic Selections tab shown in the left-hand navigation pane." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_nav_team_data_1.png?raw=true">

5. Hover over the Clinic Name > Providers heading and click on the ellipsis that appears.

<img alt="Image of Clinic Name - Providers heading and ellpsis that appears." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_nav_team_data_2.png?raw=true">

6. Click Export data > Data with Current Layout > Export.

<img alt="Image of highlighted Export data option." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_export_team_data_1.png?raw=true">

<img alt="Image of Which data do you want to export? pop-up window." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_export_team_data_2.png?raw=true">
...
<img alt="Image of team data file saved with Team naming convention." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_file_name.png?raw=true">
...
<img alt="Image of highlighted Reset button and Eraser icons." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_data_eraser_reset.png?raw=true">
...
<img alt="Image of highlighted Focus Mode icon found within data and viz tabs." src="https://github.com/lzim/mtl/blob/gh-pages/images/focus_mode.png?raw=true">
...
<img alt="Image of arrows pointing to correct document selection and Create Document button." src="https://github.com/lzim/mtl/blob/gh-pages/images/access_data_tools_1.png?raw=true">
...
<img alt="Image of VHA NDS Access Form." src="https://github.com/lzim/mtl/blob/gh-pages/images/access_data_tools_form.png?raw=true">
...
<img alt="Image of lookup supervisor search results." src="https://github.com/lzim/mtl/blob/gh-pages/images/access_data_tools_super_search.png?raw=true">
...
<img alt="Image of highlighted Corporate Data Warehouse tab." src="https://github.com/lzim/mtl/blob/gh-pages/images/access_data_tools_cdw_tab.png?raw=true">

5. Make the following selections **after** selecting the CDW SQL Datasets checkbox: 

<img alt="Image of highlighted CDW SQL Datasets to choose." src="https://github.com/lzim/mtl/blob/gh-pages/images/access_data_tools_cdw_selections.png?raw=true">
...
<img alt="Image of highlighted Settings button within the Administrator Dashboard." src="https://github.com/lzim/mtl/blob/gh-pages/images/nav_to_team_setup.png?raw=true">

2. Within the Data side of this pop-up, click Add.

<img alt="Image of highlighted Add button within Data side of Settings pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/settings_add_team_data.png?raw=true">
...
<img alt="Image of highlighted worlds selected and arrow pointing at the Upload button." src="https://github.com/lzim/mtl/blob/gh-pages/images/fac_db_select_worlds.png?raw=true">
...
<img alt="Image of File Manager pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/select_file_popup.png?raw=true">
...
<img alt="Image of Settings - Data window with possible data file selections highlighted and an arrow pointing to the Add button." src="https://github.com/lzim/mtl/blob/gh-pages/images/add_team_data.png?raw=true">

3. A Please select a world pop-up will appear. Select the world(s) in which you want the team data to appear and click Add.

<img alt="Image of Please select a world pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/settings_select_world_add.png?raw=true">

4. A confirmation message should appear in the top right side of your browser window:

<img alt="Image of added Team Data file confirmation message." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_data_added.png?raw=true">
...
<img alt="Image of Settings - Data window with possible data file selections highlighted and an arrowpointing to the Delete button." src="https://github.com/lzim/mtl/blob/gh-pages/images/delete_team_data.png?raw=true">
...
<img alt="Image of deleted Team Data file confirmation message." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_data_deleted.png?raw=true">
...
<img alt="Image of Administrator Dashboard with arrows showing how to navigate to a team's Home page." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_home.png?raw=true">

Below is a basic orientation to the Home page:

<img alt="Image of a team's Home page." src="https://github.com/lzim/mtl/blob/gh-pages/images/home_page.png?raw=true">
...
1. From the Administrator Dashboard, select a team from the Select Team dropdown, select a module (if desired), then click Home. This takes you to the selected team's Home page.
...
<img alt="Image of team Home page with arrows showing how to begin a session." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_select_data.png?raw=true">
...
<img alt="Image of expanded Team Data blue bar." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_data_upload.png?raw=true">
...
<img alt="Image of File Manager team data selection window." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_data_select.png?raw=true">
...
<img alt="Image of team data file showing in both Team Data and Session Start blue bars." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_data_file.png?raw=true">
...
<img alt="Image of Learning Mode pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_learning_mode_popup.png?raw=true">
...
<img alt="Image of Dynamic Decision Dashboard." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_initial_screen.png?raw=true">
...
<img alt="Image of Dynamic Decision Dashboard More menu options" src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_more_dropdown.png?raw=true">
...
<img alt="Image of an example feedback loop, Team Flow Story." src="https://github.com/lzim/mtl/blob/gh-pages/images/feedback_loop_popup.png?raw=true">
...
<img alt="Image of an example decision meter, Medication Management Decisions." src="https://github.com/lzim/mtl/blob/gh-pages/images/mm_decisions_popup.png?raw=true">
...
Timely access to high-quality care includes improved understanding of dynamic tradeoffs in the return-to-clinic visit interval and engagement durations. The Episodes of Care pop-up is used to graphically show evidence-based episode of care intervals to get a bird's eye view of how long the length of engagement will be. Available within the Medication Management, Psychotherapy, and Team Care modules, this pop-up integrates engagement duration and Return-to-Clinic Visit Interval (RVI) for both Medication Management and Psychotherapy.

The following screenshot will orient you to general features of this pop-up. 

<img alt="Image of the Episodes of Care pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/episode_of_care_popup.png?raw=true">
...
<img alt="Image of team Home page with arrows pointing to Please Select Team Data dropdown and the GO button." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_select_team.png?raw=true">
...
<img alt="Image of team Home page with More dropdowns and Play option highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/ddd_more_play.png?raw=true">
...
**Tip:** Save this cheatsheet [Sim UI cheatsheet](https://github.com/lzim/mtl/blob/master/blue/session05/s05_learner/mtl_how_3.7_sim_ui_cheatsheet.pdf) when running an experiment.

Below is an orientation to the Play Page of the Sim UI.

<img alt="Image of MTL Play page." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_play_page.png?raw=true">
...
<img alt="Image of Administrator Dashboard with an arrow pointing at the Team chat icon." src="https://github.com/lzim/mtl/blob/gh-pages/images/select_team.png?raw=true">
...
<img alt="Image of Team chat window." src="https://github.com/lzim/mtl/blob/gh-pages/images/private_chat.png?raw=true">
...
<img alt="Image of Team chat window with arrows showing how to continue a conversation." src="https://github.com/lzim/mtl/blob/gh-pages/images/private_chat_2.png?raw=true">
...
<img alt="Image of Team chat window with arrows showing how to begin a conversation with one or more new people." src="https://github.com/lzim/mtl/blob/gh-pages/images/new_private_chat.png?raw=true">
...
<img alt="Image of the Team chat window with an arrow pointing to the Team icon." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_navigation.png?raw=true">
...
<img alt="Image of the Team chat window highlighting all teams with which a member is associated." src="https://github.com/lzim/mtl/blob/gh-pages/images/team_listing.png?raw=true">
...
<img alt="Image of the window icon highlighted in a browser window." src="https://github.com/lzim/mtl/blob/gh-pages/images/window_view_click.png?raw=true">
...
<img alt="Image of browser window with arrow showing where to click and drag to resize the window." src="https://github.com/lzim/mtl/blob/gh-pages/images/drag_window.png?raw=true">
...
<img alt="Image of browser window with an arrow pointing to the refresh button." src="https://github.com/lzim/mtl/blob/gh-pages/images/refresh_window.png?raw=true">
...
<img alt="Image of with numbered arrows displaying how to change the browser window's zoom level." src="https://github.com/lzim/mtl/blob/gh-pages/images/zoom_window.png?raw=true">
...
<img alt="Image of highlighted Report Bug icon in the top navigation menu." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_click_icon.png?raw=true">
...
<img alt="Image of bug reporting window." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_describe_issue.png?raw=true">
...
<img alt="Image of the bug reporting screenshot dialogue." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_screenshot_upload.png?raw=true">
...
<img alt="Image of GitHub page with arrows pointing to Sign In button and Issues tab within the teampsd repo." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_nav_github.png?raw=true">

2. Click "New Issue" button.

<img alt="Image of GitHub issue page with the New issue button highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_nav_issues.png?raw=true">

3. Click "Get Started" in the "Issue" swim lane.

<img alt="Image of new GitHub issue page with the Get Started button highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_select_issue.png?raw=true">
...
<img alt="Image of GitHub Issue Form." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_issue_form.png?raw=true">
...
<img alt="Image of GitHub Issue Form showing how to route it to the bug_tracker project." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_issue_route.png?raw=true">

<img alt="Image of issue form showing correct project selection made (bug_tracker)." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_issue_route_check.png?raw=true">

6. Click the "Submit new issue" button.

<img alt="Image of GitHub Issue Form with arrow pointing at Submit new issue button." src="https://github.com/lzim/mtl/blob/gh-pages/images/bug_issue_submit.png?raw=true">
...
<img alt="Image of login dropdown showing administrator_login option" src="https://github.com/lzim/mtl/blob/gh-pages/images/admin_login.png?raw=true">
...
<img alt="Image of the Administrator Dashboard." src="https://github.com/lzim/mtl/blob/gh-pages/images/orient_admin_dash.png?raw=true">
...
<img alt="Image of Community Function Aministration page." src="https://github.com/lzim/mtl/blob/gh-pages/images/issue_list_management.png?raw=true">
...
<img alt="Image of the Issue Summary pop-up." src="https://github.com/lzim/mtl/blob/gh-pages/images/review_issue.png?raw=true">
...
<img alt="Image of the Outgoing Message Management blue bar for general orientation." src="https://github.com/lzim/mtl/blob/gh-pages/images/manage_out_msg.png?raw=true">
...
<img alt="Image of Outgoing Message Management - Alert options." src="https://github.com/lzim/mtl/blob/gh-pages/images/andon_alert.png?raw=true">
...
<img alt="Image of the MTL Demo page." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_demo_website.png?raw=true">
...
<img alt="Image of the MTL Demo Admin webpage." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_demo_orient.png?raw=true">
...
<img alt="Image of the Add Course Code pop-up with highlighted Add button." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_demo_course_code1.png?raw=true">

<img alt="Image of Add or Change Course Code pop-up with highlighted fields to complete." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_demo_course_code2.png?raw=true">
...
<img alt="Image of example Quick Tips screen." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_tips_quick_tip_screen.png?raw=true">
...
<img alt="Image of navigation steps to update Quick Tips." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_tips_quick_tip_update.png?raw=true">
...
<img alt="Image of Tutor prompt with explanatory callouts." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_tutor_desc.png?raw=true">
...
<img alt="Image of tutor functionality within the Sim UI." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_tutor_admin_page.png?raw=true">
...
<img alt="Image of highlighted MTL Guides and MTL Navigation blue bars within the More Info Admin Page." src="https://github.com/lzim/mtl/blob/gh-pages/images/moreinfo_guides_navigation.png?raw=true">

#### _MTL_ Links and References Pages

Below is the _MTL_ Links page.

<img alt="Image of the MTL Links page." src="https://github.com/lzim/mtl/blob/gh-pages/images/moreinfo_links.png?raw=true">
...
<img alt="Image of the MTL References page." src="https://github.com/lzim/mtl/blob/gh-pages/images/moreinfo_references.png?raw=true">

##### Update Links and References 

Below is the Links and References maintenance section of the More Info Admin page.

<img alt="Image of the MTL More Information Links and References Section Maintenance blue bar." src="https://github.com/lzim/mtl/blob/gh-pages/images/moreinfoadmin_links_references.png?raw=true">
...
<img alt="Image of the MTL Modules blue bar." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_moreinfo_modules.png?raw=true">
...
<img alt="Image of the MTL More Information Module Section Maintenance blue bar." src="https://github.com/lzim/mtl/blob/gh-pages/images/mtl_moreinfo_module1.png?raw=true">
...
<img alt="Image of the Forio Epicenter dashboard with Veterans Affairs group highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/navigate_to_vet_affairs_project.png?raw=true">

##### Select End User from Menu
  
You can search for the user by using the search bar.

<img alt="Image of highlighted Forio End Users tab." src="https://github.com/lzim/mtl/blob/gh-pages/images/select_end_user.png?raw=true">
...
<img alt="Image of Send Reset Password Link option highlighted under the Edit dropdown." src="https://github.com/lzim/mtl/blob/gh-pages/images/click_password_link.png?raw=true">
...
<img alt="Image of VA Projects page within Forio with PROD project highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/select_prod_project.png?raw=true">
...
<img alt="Image of the Groups tab highlighted in the right-hand navigation area." src="https://github.com/lzim/mtl/blob/gh-pages/images/click_groups.png?raw=true">

##### Select Desired Group

<img alt="Image of a desired group highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/select_desired_group.png?raw=true">

##### Click Add End User Button

<img alt="Image of the Add End Users button highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/add_end_users.png?raw=true">
...
<img alt="Image of the Add End Users page with fields to complete highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/add_invite_user.png?raw=true">
...
<img alt="Image of the administrator_login group highlighted." src="https://github.com/lzim/mtl/blob/gh-pages/images/admin_end_user.png?raw=true">
