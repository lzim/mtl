...
- **Note:** If you have the Administrator role in any team and have been added into "administrator_login" in Epicenter, you will be allowed to login using the "administrator_login" choice. Upon logging in, Administrators are directed to the [Administrator Dashboard](#sim-ui-administrator-dashboard).
